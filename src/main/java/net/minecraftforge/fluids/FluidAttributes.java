...
public class FluidAttributes
{
    ...
    {
        this.translationKey = builder.translationKey != null ? builder.translationKey :  Util.createTranslationKey("fluid", fluid.getRegistryName());
    ...
    public Identifier getStillTexture(FluidStack stack) { return getStillTexture(); }
    public Identifier getFlowingTexture(FluidStack stack) { return getFlowingTexture(); }
    ...
    public int getLuminosity(BlockRenderView world, BlockPos pos){ return getLuminosity(); }
    public int getDensity(BlockRenderView world, BlockPos pos){ return getDensity(); }
    public int getTemperature(BlockRenderView world, BlockPos pos){ return getTemperature(); }
    public int getViscosity(BlockRenderView world, BlockPos pos){ return getViscosity(); }
    public boolean isGaseous(BlockRenderView world, BlockPos pos){ return isGaseous(); }
    public Rarity getRarity(BlockRenderView world, BlockPos pos){ return getRarity(); }
    public int getColor(BlockRenderView world, BlockPos pos){ return getColor(); }
    public Identifier getStillTexture(BlockRenderView world, BlockPos pos) { return getStillTexture(); }
    public Identifier getFlowingTexture(BlockRenderView world, BlockPos pos) { return getFlowingTexture(); }
    public SoundEvent getFillSound(BlockRenderView world, BlockPos pos) { return getFillSound(); }
    public SoundEvent getEmptySound(BlockRenderView world, BlockPos pos) { return getEmptySound(); }
