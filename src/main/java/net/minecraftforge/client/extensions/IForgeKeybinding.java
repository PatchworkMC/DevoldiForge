...
public interface IForgeKeybinding
{
    ...
    @Nonnull InputUtil.KeyCode getKey();
    ...
    {
        return keyCode != InputUtil.UNKNOWN_KEYCODE && keyCode.equals(getKey()) && getKeyConflictContext().isActive() && getKeyModifier().isActive(getKeyConflictContext());
    }
