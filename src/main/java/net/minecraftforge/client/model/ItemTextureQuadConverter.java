...
public final class ItemTextureQuadConverter
{
     ...
     */
    public static List<BakedQuad> convertTexture(Rotation3 transform, Sprite template, Sprite sprite, float z, Direction facing, int color, int tint)
    {
     ...
     */
    public static List<BakedQuad> convertTextureHorizontal(Rotation3 transform, Sprite template, Sprite sprite, float z, Direction facing, int color, int tint)
    {
     ...
     */
    public static List<BakedQuad> convertTextureVertical(Rotation3 transform, Sprite template, Sprite sprite, float z, Direction facing, int color, int tint)
    {
        int w = template.getWidth();
        int h = template.getHeight();
        float wScale = 16f / (float)w;
     ...
     */
    public static BakedQuad genQuad(Rotation3 transform, float x1, float y1, float x2, float y2, float z, Sprite sprite, Direction facing, int color, int tint)
    {
        float u1 = sprite.getFrameU(x1);
        float v1 = sprite.getFrameV(y1);
        float u2 = sprite.getFrameU(x2);
        float v2 = sprite.getFrameV(y2);
    ...
    private static BakedQuad putQuad(Rotation3 transform, Direction side, Sprite sprite, int color, int tint,
