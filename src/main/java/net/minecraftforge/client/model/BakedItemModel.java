...
public class BakedItemModel implements BakedModel
{
    ...
    public BakedItemModel(ImmutableList<BakedQuad> quads, Sprite particle, ImmutableMap<Mode, Rotation3> transforms, ModelItemPropertyOverrideList overrides, boolean untransformed, boolean isSideLit)
    {
        this.quads = quads;
    ...
    private static boolean hasGuiIdentity(ImmutableMap<Mode, Rotation3> transforms)
    {
        Rotation3 guiTransform = transforms.get(Mode.GUI);
