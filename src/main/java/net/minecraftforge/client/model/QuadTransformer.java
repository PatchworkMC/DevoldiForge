...
public class QuadTransformer
{
    ...
    public QuadTransformer(Rotation3 transform)
    {
    ...
    public BakedQuad processOne(BakedQuad input)
    {
        ...
        return new BakedQuad(outData, input.getColorIndex(), input.getFace(), input.a(), input.shouldApplyDiffuseLighting());
    }
    ...
    public List<BakedQuad> processMany(List<BakedQuad> inputs)
    {
        ...
        for(BakedQuad input : inputs)
        {
            ...
            outputs.add(new BakedQuad(outData, input.getColorIndex(), input.getFace(), input.a(), input.shouldApplyDiffuseLighting()));
        }
        return outputs;
    }
