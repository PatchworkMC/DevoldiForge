...
public class BlockModelConfiguration implements IModelConfiguration
{
    ...
    public BakedModel bake(ModelLoader bakery, Function<SpriteIdentifier, Sprite> bakedTextureGetter, ModelBakeSettings modelTransform, ModelItemPropertyOverrideList overrides, Identifier modelLocation)
    {
        IModelGeometry<?> geometry = getCustomGeometry();
        if (geometry == null)
