...
public interface IForgeBlockState
{
     ...
     */
    default Optional<Vec3d> getBedSpawnPosition(EntityType<?> type, WorldView world, BlockPos pos, @Nullable LivingEntity sleeper)
    {
     ...
     */
    default void setBedOccupied(WorldView world, BlockPos pos, LivingEntity sleeper, boolean occupied)
    {
    ...
    */
     ...
     */
    default boolean isBedFoot(WorldView world, BlockPos pos)
    {
     ...
     * @param pos Block position in world
     */
    default void beginLeaveDecay(WorldView world, BlockPos pos)
    {
     ...
     */
    default boolean isReplaceableOreGen(WorldView world, BlockPos pos, Predicate<BlockState> target)
    {
     ...
     */
    default float getExplosionResistance(WorldView world, BlockPos pos, @Nullable Entity exploder, Explosion explosion)
    {
     ...
     */
    default boolean isFoliage(WorldView world, BlockPos pos)
    {
    ...
    */
    default boolean isBeaconBase(WorldView world, BlockPos pos, BlockPos beacon)
    {
     ...
     */
    default boolean isPortalFrame(WorldView world, BlockPos pos)
    {
