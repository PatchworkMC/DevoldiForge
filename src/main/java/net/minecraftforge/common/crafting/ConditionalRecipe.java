...
public class ConditionalRecipe
{
    ...
    public static class Builder
    {
        ...
        public Builder setAdvancement(Identifier id, ConditionalAdvancement.Builder advancement)
        {
            if (this.advId != null)
    ...
    private static class Finished implements RecipeJsonProvider
    {
        ...
        private Finished(Identifier id, List<ICondition[]> conditions, List<RecipeJsonProvider> recipes, Identifier advId, ConditionalAdvancement.Builder adv)
        {
            this.id = id;
