...
public class PlayerEvent extends LivingEvent
{
    ...
    public static class NameFormat extends PlayerEvent
    {
        ...
        private final Text usernameComponent;
        private Text displaynameComponent;
        ...
        public NameFormat(PlayerEntity player, String username) 
        {
            ...
            this.usernameComponent = new LiteralText(username);
            this.setDisplaynameComponent(new LiteralText(username));
        }
        ...
        public void setDisplayname(String displayname)
        {
            ...
            this.displaynameComponent = new LiteralText(displayname);
        }
        
        public Text getUsernameComponent()
        {
            return usernameComponent;
        }

        public Text getDisplaynameComponent()
        {
            return displaynameComponent;
        }

        public void setDisplaynameComponent(Text displayname)
        {
